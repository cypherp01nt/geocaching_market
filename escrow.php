...
if ( isset($_SESSION["user"]) && isset($_POST["id"]) ) {
	...
	<a href="my_tradeZ.php">Meine Handel</a>
	...
	$file_0confirmations = fopen("https://testnet.blockchain.info/q/addressbalance/$escrowAddress?confirmations=0", "r");
	$balance_0confirmations = fgets($file_0confirmations);
	//prevent ip block caused by too much requests without api-key
	if ( 0 == $balance_0confirmations) {	
		$balance_6confirmations = 0;
	} else { 
		$file_6confirmations = fopen("https://testnet.blockchain.info/q/addressbalance/$escrowAddress?confirmations=6", "r");
		$balance_6confirmations = fgets($file_6confirmations);
	}
